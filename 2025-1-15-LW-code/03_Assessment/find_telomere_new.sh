#!/bin/bash
#nohup bash find_telomere_new.sh chm13.draft_v1.0 0.4 1000 chm13.draft_v1.0.fasta &
genome=$1
...
Java=/home/jxlabgdp/01.Biosoft/jdk-18.0.2/bin/java
VGP_PIPELINE=~/01.Biosoft/03.Sif/vgp-assembly/pipeline/
cpus=30
...
# Find windows using variable $thresholds ;99.9 represent base accurary
echo "
